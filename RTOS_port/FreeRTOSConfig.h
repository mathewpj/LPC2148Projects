 ...
 *----------------------------------------------------------*/
#define configSUPPORT_STATIC_ALLOCATION 0 //I Added
#define	configUSE_TASK_NOTIFICATIONS    1 //I Added
...
#define configGENERATE_RUN_TIME_STATS		0	/* Use for debugging: Uses some overhead along and TIMER1 */
#define configCHECK_FOR_STACK_OVERFLOW  	0	/* Use for debugging initially until you are sure you have set correct stack sizes, then set to 0 */
...
#define configUSE_16_BIT_TICKS				1	/* LEAVE TO 0 since ARM7 is 32-bit */
#define configIDLE_SHOULD_YIELD				1	/* If tasks share idle priority, idle task will yield to them */
